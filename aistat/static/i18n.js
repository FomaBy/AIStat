...
const I18N = (() => {
  ...
  const messages = {
    ...
    agentsWorked: ["Агентов", "Agents"], agentWorkTime: ["Время работы агентов", "Agent work time"], qualityAdjustedCost: ["Качество-скорректированная стоимость", "Quality-adjusted cost"], qualityAdjustedCostSub: ["USD на принятый SP · все попытки включены", "USD per accepted SP · all attempts included"], lessIsBetterTokens: ["токенов на 1 SP · меньше — лучше", "tokens per 1 SP · lower is better"], lessIsBetterCost: ["USD на 1 SP · меньше — лучше", "USD per 1 SP · lower is better"], lessIsBetterWeighted: ["USD/час на 1 SP · меньше — лучше", "USD/hour per 1 SP · lower is better"], workedInPeriod: ["выполняли работу за период", "worked during the period"], totalForAgents: ["суммарно по всем агентам", "total across all agents"],
