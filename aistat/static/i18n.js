...
const I18N = (() => {
  ...
  const messages = {
    ...
    noGlobalModels: ["Пока нет данных от пользователей.", "No user data yet."],
    usersColumn: ["Пользователи", "Users"],
    globalModelsNote: ["Анонимизированные суммарные данные всех пользователей AIStat: только модель, токены, story points и стоимость — без задач, проектов, агентов и имён. Фильтры дашборда не применяются; значения за всё время.", "Anonymized totals across all AIStat users: only model, tokens, story points and cost — no issues, projects, agents or names. Dashboard filters do not apply; values cover all time."],
