...
Статус: **этап 2 из 4** — добавлены официальные тарифы моделей, расчёт
стоимости токенов в USD и пересчёт в кредиты. Готово: каркас, ингест-поллер,
SQLite-схема, health (этап 1); тарифы + стоимость + кредиты (этап 2).
Дальше: API агрегатов + дашборд (этап 3), сквозное QA (этап 4).
